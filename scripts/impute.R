...
data_rf <- data %>%
  dplyr::select(c(lfdn, acc, app, age, loc, chld, inc, ppref, gen, dlic, job, dfreq, npice, mlib, vera,
                  pger, envc, emat, proba, wac, wev, v_49, v_91, v_45, v_46, v_47, v_51, v_52, v_53))
